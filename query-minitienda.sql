...
-- INSERT
DELIMITER //
CREATE PROCEDURE sp_insert_provider(IN v_nit VARCHAR(45), IN v_nombre VARCHAR(100))
BEGIN
...
-- UPDATE
DELIMITER //
CREATE PROCEDURE sp_update_provider(IN v_id INT, IN v_nit VARCHAR(45), IN v_nombre VARCHAR(100))
BEGIN
...
-- SHOW
DELIMITER //
CREATE PROCEDURE sp_show_provider()
BEGIN
...
-- DELETE
DELIMITER //
CREATE PROCEDURE sp_delete_provider(IN v_id INT)
BEGIN
